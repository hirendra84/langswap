...
sys.path.append("/app/coqui-ai-TTS")
...
class TTSClient(ABC):
    ...
    def tts_pipelene(
        self, data: list[TranslatedTextedSegment], output_folder: str
...
class VoiceToneConverter:
    ...
    def voice_conversion_pipeline(self, video_translation, temp_folder, source_lang):
        ...
        clean_audio_speaker = video_translation.background_audio["vocals.wav"].replace(
...
class XTTSClient:
    def __init__(
        ...
        print(os.path.abspath(tts_model_id))
