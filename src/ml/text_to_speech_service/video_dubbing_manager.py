...
class VideoDubbingManager:
    ...
    def change_pauses(self, wav_gen_path: str, wav_source_path: str,
        ...
        if pause_dur_gen:
            ...
            print(f"{pause_reduction} for wav file {wav_gen_path}")
    ...
    def merge_timestamps_speedup(self, video_translation, vocals_audio):
        ...
        for idx, segment in enumerate(video_translation.translated_texts):
            ...
            print(f"generated audio length {audio_length}, source file length {source_length}")
            ...
            if source_length - audio_length < 0: # should compare with the extention in the pause
